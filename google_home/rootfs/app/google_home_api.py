...
class DeviceState(BaseModel):
    ...
    attributes: dict[str, Any] = Field(default_factory=dict, description="Device state attributes")
            ...
            for device_data in payload.get("devices", []):
                try:
                    device = Device(
                        ...
                        traits=[trait for trait in device_data.get("traits", [])],
                        room=device_data.get("roomHint", None),
                        manufacturer=device_data.get("deviceInfo", {}).get("manufacturer", None),
                        model=device_data.get("deviceInfo", {}).get("model", None),
                        hw_version=device_data.get("deviceInfo", {}).get("hwVersion", None),
                        sw_version=device_data.get("deviceInfo", {}).get("swVersion", None),
                    )
